TL;DR: BiasTapeHalf_mod_1.stl and Double_Folder_mod_1.stl are the ones you want; take cloth 1" wide, one makes it into bias tape, (and you run it under an iron as it comes out), the other takes it and folds it in half, and you can run it into your sewing machine.  They have slots for feeding tape through to attach to your ironing board and sewing machine.
